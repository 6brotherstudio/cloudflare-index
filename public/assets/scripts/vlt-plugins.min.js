!(function (t) {
      ...
      if (S) {
        ...
        if (
          ...
          if (
            ...
            var h = o.rootElement.querySelectorAll(
  ...
  (function (t, e) {
    ...
    function G(t) {
      ...
      return (
        n(a)
          ? (h = p = { center: 0.5, edges: 0.5, end: 1 }[a] || 0)
          : !c && d && ((h = a[0]), (p = a[1])),
        function (t, n, s) {
          var o,
            c,
          ...
          if (!T) {
            if (!(x = "auto" === e.grid ? 0 : (e.grid || [1, Ee])[1])) {
              for (
                b = -Ee;
                b < (b = s[x++].getBoundingClientRect().left) && x < S;
    ...
    function ht(t) {
      ...
      fe < n && (ve += n - me),
        ...
        (he.time = (ge - ve) / 1e3),
        (0 < (e = he.time - ye) || s) &&
          (he.frame++, (ye += e + (be <= e ? 0.004 : be - e)), (i = 1)),
        s || (ce = de(ht)),
        i &&
    ...
    function mt(t, e, i, a, r, l) {
      ...
      if (
        ...
        for (u = i._ptLookup[i._targets.indexOf(r)], h = c._props.length; h--; )
          u[c._props[h]] = d;
      return c;
    }
    function vt(t, e, i) {
      ...
      return r.svg && t.getAttribute("transform")
        ...
        : (l !== kn ||
            ...
            ((i = t.parentNode) && t.offsetParent) ||
              ((a = 1), (n = t.nextSibling), Vi.appendChild(t)),
            (l = Gt(t)),
    ...
    var mi,
      ...
      gi =
        ...
        (mi.repeat = function (t) {
          return arguments.length
            ? ((this._repeat = t), V(this))
            : this._repeat;
        }),
        (mi.repeatDelay = function (t) {
          return arguments.length
            ? ((this._rDelay = t), V(this))
            : this._rDelay;
        }),
        (mi.yoyo = function (t) {
    ...
    var bi = (function (t) {
      ...
      return (
        ...
        (o.addPause = function (t, e, i) {
          ...
          return (
            (n.data = "isPause"), (this._hasPause = 1), R(this, n, N(this, t))
          );
        }),
          ...
          for (
            ...
            if (
              ...
              u &&
                ...
                ((e._pt = r =
                  new Fi(e._pt, o, h.name, 0, 1, h.render, h, 0, h.priority)),
          ...
          (r.kill = function (t, e) {
            ...
            for (
              ...
              if (~u.indexOf(d[c]))
                ...
                r))
                  (l = s && s[o]) &&
                    (("kill" in l.d && !0 !== l.d.kill(o)) || A(this, l, "_pt"),
                    delete s[o]),
                    "all" !== a && (a[o] = 1);
                      ...
                      (r = Yt(r)),
                        b.svg
                          ...
                          : ((f = parseFloat(r.split(" ")[2]) || 0) !==
                              b.zOrigin && Ht(this, b, "zOrigin", b.zOrigin, f),
      ...
      i.extend(v.prototype, {
        ...
        jumpTo: function (t, e) {
          ...
          if (!(h.isDragging || h.isClosing || (h.isAnimating && h.firstRun))) {
            if (
              ((t = parseInt(t, 10)),
              !(a = h.current ? h.current.opts.loop : h.opts.loop) &&
                (t < 0 || t >= f))
            )
              return !1;
            if (
  ...
  (function (t, e, i, n) {
    ...
    t.fn.pagepiling = function (s) {
      ...
      function c(e) {
        t.isFunction(J.afterLoad) &&
          J.afterLoad.call(this, e.anchorLink, e.sectionIndex + 1);
      }
      function d(e) {
      ...
      function S(t, e) {
        ...
        if (
          ("down" == t
            ? ((i = "bottom"), (n = H.moveSectionDown))
            : ((i = "top"), (n = H.moveSectionUp)),
          e.length > 0)
        ) {
          if (!T(i, e)) return !0;
          n();
      ...
      function E() {
        V.get(0).addEventListener
          ? (V.get(0).removeEventListener("mousewheel", w, !1),
            V.get(0).removeEventListener("wheel", w, !1))
          : V.get(0).detachEvent("onmousewheel", w);
      }
      function _() {
        V.get(0).addEventListener
          ? (V.get(0).addEventListener("mousewheel", w, !1),
            V.get(0).addEventListener("wheel", w, !1))
      ...
      function O(e, i) {
        ...
        return (
          !!(
            i < J.normalScrollElementTouchThreshold &&
            n.is(J.normalScrollElements)
          ) ||
      ...
      function I() {
        ...
        for (var i = 0; i < t(".pp-section").length; i++) {
          var n = "";
          if (
            (J.anchors.length && (n = J.anchors[i]),
      ...
      t.extend(t.easing, {
        ...
        (H.setAllowScrolling = function (t) {
          t
            ? (H.setMouseWheelScrolling(!0), M())
            : (H.setMouseWheelScrolling(!1), k());
        }),
      ...
      t(".pp-section")
        .each(function (e) {
          t(this).data("data-index", e),
            ...
            void 0 !== J.anchors[e] &&
              t(this).attr("data-anchor", J.anchors[e]),
            void 0 !== J.sectionsColor[e] &&
              t(this).css("background-color", J.sectionsColor[e]),
            J.verticalCentered &&
      ...
      if (
        ...
        if (n.freeMode) {
          ...
          if (h > n.longSwipesMs) {
            ...
            "next" === e.swipeDirection &&
              (z >= n.longSwipesRatio ? e.slideTo(P + O) : e.slideTo(P)),
            ...
            for (
              ...
              if (e.slidesPerColumn > 1) {
                ...
                if ("row" === e.slidesPerColumnFill && e.slidesPerGroup > 1) {
                  ...
                  (L =
                    (A =
                      I - (z = Math.floor(I / D)) * D + O * e.slidesPerGroup) +
                    (z * T) / _),
                    $.css({
